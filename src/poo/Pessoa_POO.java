    ...
    public void validar(int etapa) {
        switch (etapa) {
            ...
            case 2:
                while (anoNasc <= 1900) {
                    anoNasc = Integer
                            .parseInt(JOptionPane.showInputDialog("[IDADE INCOMPATÍVEL]\n\n" + "DIGITE UMA IDADE"));
                }
                break;
            case 3:
                while ("".equals(cpf)) {
            ...
            case 4:
                while ("".equals(salario) || salario < 1045) {
                    salario = Double.parseDouble(
                            JOptionPane.showInputDialog("[O SALARIO DEVE SER IGUAL OU MAIOR AO SALARIO MÍNIMO]\n\n"
                                    + "Salario Mínimo: R$ 1045,00 \n\nDigite o seu salário novamente: "));
                }
                break;
            case 5:
                while ("".equals(ano_desconto) || salario <= 0) {
                    ano_desconto = Integer.parseInt(JOptionPane
                            .showInputDialog("[O ANO QUE O CLIENTE FEZ SUA PRIMEIRA COMPRA NA LOJA NÃO PODE SER ZERO]\n\n"
